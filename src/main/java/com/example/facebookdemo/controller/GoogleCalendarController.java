...
public class GoogleCalendarController {
    ...
    private static void createEvent() throws GeneralSecurityException, IOException {
    ...
    public ResponseEntity<String> getEvents(@AuthenticationPrincipal OAuth2User oAuth2User,
        ...
        final DateTime date1 = new DateTime(startDate + "T00:00:00");
        final DateTime date2 = new DateTime(endDate + "T23:59:59");
